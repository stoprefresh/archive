...
public class VehicleApp {
  ...
  public void run() {
    ...
    // Changing Vehicle to abstract has no effect on this code:
    // No Vehicle objects are instantiated, only subclasses.
    // Vehicle declares no abstract methods, so no subclasses need modification.
