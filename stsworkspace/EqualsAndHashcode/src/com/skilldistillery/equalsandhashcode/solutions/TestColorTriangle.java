...
public class TestColorTriangle {
  ...
  public void test() {
    ColorTriangle blueTriangle1 = new ColorTriangle(5, 7, new RGBColor2(0,0,255));
    ColorTriangle blueTriangle2 = new ColorTriangle(5, 7, new RGBColor2(0,0,255));
    ColorTriangle blueTriangle3 = new ColorTriangle(7, 5, new RGBColor2(0,0,255));
    ColorTriangle greenTriangle = new ColorTriangle(5, 7, new RGBColor2(0,255,0));
