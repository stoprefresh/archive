...
public class Rectangle extends Shape {
	...
	public void setWidth(double width) {
		if (width <= 0.0) {
			throw new IllegalArgumentException("Cannot have 0 or less entered for the Width");
		}
		this.width = width;
	...
	public void setHeight(double height) {
		if (height <= 0.0) {
			throw new IllegalArgumentException("Cannot have 0 or less entered for the Height");
		}
		this.height = height;
