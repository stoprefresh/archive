...
public class PresidentAppInnerClassesLamba {
...
//	}
	public static void main(String[] args) {
		PresidentAppInnerClassesLamba app = new PresidentAppInnerClassesLamba();
		app.start();
...
//	}
	...
	public void start() {
         ...
         List<President> listP = new ArrayList<President>(this.getPresidents());
         Collections.sort(listP, (o1, o2) -> o1.getParty().compareTo(o2.getParty()));
		...
		printPresidents(filter("William", (p, s) -> p.getFirstName().contains(s)));
		...
		printPresidents(filter("Term Ended", (p, s) -> p.getWhyLeftOffice().equalsIgnoreCase(s)));
		...
		printPresidents(filter("C", (p, s) -> p.getLastName().contains(s)));
		...
		printPresidents(filter("Democrat", (p, s) -> p.getParty().contains(s)));
		...
		printPresidents(filter("1", (p, s) -> Integer.toString(p.getElectionsWon()).contains(s)));
		...
		printPresidents(filter("19", (p, s) -> Integer.toString(p.getBeganTerm().getYear()).contains(s)));
...
//	}
	...
	public PresidentAppInnerClassesLamba() {
